...
namespace ADL.SCORM2004 {
    ...
    export var _AlreadyInitialized = { "code": "103", "string": "Already Initialized", "diagnostic": "Already Initialized" };
    ...
    **
    *******************************************************************************/
    export function doInitialize(): string {
    ...
    *******************************************************************************/
    function findObjective(objId) {
        var num = parseInt(doGetValue("cmi.objectives._count"));
        var objIndex = -1;
    ...
    *******************************************************************************/
    function findDataStore(id) {
        var num = parseInt(doGetValue("adl.data._count"));
        var index = -1;
